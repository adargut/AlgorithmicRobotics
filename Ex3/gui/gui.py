...
#qt designer generated code
  ...
  def add_segment(self, x1, y1, l, a, line_color=QtCore.Qt.black):
    s = RSegment(x1, y1, l, a, line_color, line_width = self.base_line_width / self.zoom)
    self.scene.addItem(s.line)
    self.scene.addItem(s.point)
    return s
  ...
  def general_segment_animation(self, obj, ix, iy, ia, x, y, a, clockwise, duration = 2000):
